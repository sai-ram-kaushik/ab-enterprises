...
const PrivacyPolicy = () => {
  return (
    <div className="flex flex-col items-start gap-2 text-background">
      ...
      <h3 className="text-[18px] font-semibold">SECTION 2 - CONSENT</h3>
      <h3 className="text-[17x] font-medium">How do you get my consent?</h3>
      <p>
      ...
      <h3 className="text-[17px] font-medium">How do I withdraw my consent?</h3>
      <p>
        ...
        abenterprises680@gmail.com or mailing us at: 1001, DLF Corporate Greens,
        Sec. 74A, Gurugram, HR. -122004
      </p>

      <h3 className="text-[18px] font-semibold">SECTION 3 - DISCLOSURE</h3>
      <p>
        We may disclose your personal information if we are required by law to
        do so or if you violate our Terms of Service.
      </p>

      <h3 className="text-[18px] font-semibold">SECTION 4 - PAYMENT</h3>
      <p>
      ...
      <p>
        ...
        razorpay on <a href="https://razorpay.com">https://razorpay.com</a>
      </p>
      ...
      <h3 className="text-[18px] font-semibold">SECTION 6 - SECURITY</h3>
      <p>
      ...
      <h3 className="text-[18px] font-semibold">SECTION 7 - COOKIES</h3>
      <p>
        We use cookies to maintain session of your user. It is not used to
        personally identify you on other websites.
      </p>

      <h3 className="text-[18px] font-semibold">SECTION 8 - AGE OF CONSENT</h3>
      <p>
      ...
      <p>
        ...
        abenterprises680@gmail.com or by mail at 1001, DLF Corporate Greens,
        Sec. 74A, Gurugram, HR. -122004
      </p>
    </div>
  );
