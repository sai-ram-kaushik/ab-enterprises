  ...
  return (
    <div className="flex flex-col items-start gap-2 text-primary px-5 lg:px-36">
      ...
      <p>
        ...
        applicable) Book with obvious signs of use Any item not in its original
        condition, is damaged or missing parts for reasons not due to our error.
        Any item that is returned more than 30 days after delivery.
      </p>
      <h3 className="text-[17px] font-bold">Refunds (if applicable)</h3>
      <p>
        ...
        you of the approval or rejection of your If you are approved, then your
      ...
      <h3 className="text-[17px] font-bold">Sale items (if applicable)</h3>
      <p>
        Only regular priced items may be refunded, unfortunately sale items
        cannot be refunded
      </p>

      <h3 className="text-[17px] font-bold">Exchanges (if applicable)</h3>
      <p>
        We only replace items if they are defective or damaged. If you need to
        exchange it for the same item, send us an email at
        abenterprises680@gmail.com. and send your item to: 1001, DLF Corporate
        Greens, Sec. 74A, Gurugram, HR. 122004. Gifts
      </p>
      <p>
      ...
      <h3 className="text-[17px] font-bold">Shipping</h3>
      <p>
        To return your product, you should mail your product to: 1001, DLF
        Corporate Greens, Sec. 74A, Gurugram, HR. 122004.
      </p>
      <p>
      ...
      <p>
        ...
        product to reach you, may very
      </p>
      <p>
        If you are shipping an item over INR 10,000, you should consider using a
