  ...
  return (
    <div className="flex flex-col items-start gap-2 text-primary px-5 md:px-36">
      <div className="flex items-center justify-center w-full">
        <h3 className="text-[20px] font-heading font-bold mt-5">
      ...
      <div className="">
        <h3>OVERVIEW</h3>
        <p>
          This website is operated by A. B. Enterprises. Throughout the site,
          the terms "we", "us" and “our” refer to A. B. Enterprises. A. B.
          Enterprises offers this website, including all information, tools and
        ...
        <h3 className="font-bold mt-5">SECTION 1 - ONLINE STORE TERMS </h3>
        <p>
        ...
        <h3 className="font-bold mt-5">SECTION 2 - GENERAL CONDITIONS</h3>
        <p>
        ...
        <h3 className="font-bold mt-5">SECTION 5 - PRODUCTS OR SERVICES</h3>
        <p>
        ...
        <h3 className="font-bold mt-5">SECTION 7 - OPTIONAL TOOLS</h3>
        <p>
        ...
        <p>
          ...
          the relevant third-party provider(s). We may also, in the future,
        ...
        <h3 className="font-bold mt-5">SECTION 8 - THIRD-PARTY LINKS</h3>
        <p>
        ...
        <h3 className="font-bold mt-5">SECTION 10 - PERSONAL INFORMATION</h3>
        <p>
        ...
        <h3 className="font-bold mt-5">SECTION 12 - PROHIBITED USES</h3>
        <p>
        ...
        <p>
          In no case shall A. B. Enterprises, our directors, officers,
        ...
        <h3 className="font-bold mt-5">SECTION 14 - INDEMNIFICATION</h3>
        <p>
          You agree to indemnify, defend and hold harmless [_______Company Name
        ...
        <h3 className="font-bold mt-5">SECTION 15 - SEVERABILITY</h3>
        <p>
        ...
        <h3 className="font-bold mt-5">SECTION 16 - TERMINATION </h3>
        <p>
        ...
        <h3 className="font-bold mt-5">SECTION 17 - ENTIRE AGREEMENT </h3>
        <p>
        ...
        <h3 className="font-bold mt-5">SECTION 18 - GOVERNING LAW </h3>
        <p>
          These Terms of Service and any separate agreements whereby we provide
          you Services shall be governed by and construed in accordance with the
          laws of India and jurisdiction of Gurugram, Haryana
        </p>

        <h3 className="font-bold mt-5">SECTION 19 - CHANGES TO TERMS OF SERVICE</h3>
        <p>
        ...
        <h3 className="font-bold mt-5">SECTION 20- CONTACT INFORMATION </h3>
        <p>
          Questions about the Terms of Service should be sent to us at
          <a href="mailto:abenterprises680@gmail.com">
            abenterprises680@gmail.com
          </a>
          .
        </p>
      </div>
